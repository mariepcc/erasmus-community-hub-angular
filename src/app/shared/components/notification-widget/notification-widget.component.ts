  ...
  notifications: Notification[] = [
    {
      ...
      message: 'Sarah Johnson liked your post about Erasmus experience in Madrid',
      time: '5 minutes ago',
      read: false
    },
    {
      ...
      message: 'Mike Chen commented on your post: "This looks amazing! How long did you stay?"',
      time: '1 hour ago',
      read: false
    },
    {
    ...
    },
    {
      ...
      message: 'New event in Barcelona: International Food Festival this weekend',
      time: '1 day ago',
      read: true
    }
  ];
